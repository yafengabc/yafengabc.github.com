...
2，在msys2直接安装python，配合msys2的gcc，这样类似直接在linux安装gcc python，最方便，编译连接时也不需要指定路径，类似linux下的体验，缺点是编译生成
...
> 原文链接（Cnblogs）：[点击查看](https://www.cnblogs.com/yafengabc/p/11399939.html)
